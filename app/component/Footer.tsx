    ...
    >
      ...
      <div
        style={{
          ...
          height: "1px",
          background:
            "linear-gradient(90deg, transparent 0%, var(--accent-blue) 25%, var(--accent-purple) 50%, var(--accent-teal) 75%, transparent 100%)",
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            © 2026 Uzoefuna Benson. All rights reserved.
          </p>
          <p
            style={{
              fontFamily: "var(--font-mono)",
