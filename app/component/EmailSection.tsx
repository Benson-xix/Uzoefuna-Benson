...
const EmailSection = () => {
  ...
  return (
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
        <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-orange-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 "></div>
      <div className="flex flex-col gap-3 z-10">
        <h5 className=" lg:text-5xl text-xl text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-700 to-orange-500 font-bold">Connect With Benson</h5>
        <p className="text-white nb-4 max-w-md">
            {" "}
            i'm currently looking for new Opportunities, my inbox is always open.
            Whether you have a question or just want to say hi, i'll try my best
            to reach out to you!.
            Please you can contact me either through the Form or  directly via <a href="mailto:bensondomini81@gmail.com" className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-slate-700 to-purple-200 font-semibold ">bensondominic81@gmail.com</a>
        </p>
